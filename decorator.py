...
# def Wrapper(func):
#     def inner2(a, b):
#         print("I am Doing substraction operation")
#         func(a, b)
#
#     return inner2
#
...
#
#
# @outer_most("I am doing Addition operation")
# def Add(a, b):
#     print(a + b)
#
#
...
#
#
# @outer_most("I am doing substraction operation")
# def Sub(a, b):
#     print(a - b)
#
#
...
#
#
# @outer_most("I am doing multiplication operation")
# def MUl(a, b):
#     print(a * b)
#
#
...
#
# Oct 07 - 6:41 pm
# Akshay_Warhade_Resume(CCTPL).pdf
# Click to download
# Oct 07 - 6:55 pm
# https://apply.workable.com/v4c/j/BA848A8DD3/
#
#
#
# guys fill this form apply fast
#
# Oct 07 - 7:41 pmPDE-PFFPTD-M32
# '''
# Total_calling = 0
#
#
...
# spam()
# spam()
# print(f"Total function calling count is {Total_calling}")
# '''
#
#
# '''
...
@Most_outer(2)
def check():
    print("the check methods ")

@Most_outer(4)
def spam():
    print("the spam methods ")
@Most_outer(2)
def display():
    print("the display methods ")
check()
spam()
display()
#        Decorators Examples
...
def outer(fun):
    def inner(*args,**kwargs):
        ...
        print("the calculate a time ---> ",end-start)
    return inner
@outer
def mul(a,b):
    print(a*b)
...
def add (a,b):
    print(a,b)
    print("addtional operation is done")
add(21,9)
